	...
	else
	{
		...
		foreach($result as $row)
		{
			...
			else
			{
				...
				<p>Your email is successfully verify, so now you can login into this Online Student Management System by visiting <a href="'.$object->base_url.'login.php" target="_blank"><b>'.$object->base_url.'login.php</a></b> this link. Below you can find login details.</a></p>
			    <p><b>username : <b>'.$row["student_name"].'

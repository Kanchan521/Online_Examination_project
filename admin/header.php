...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#students_collapse" aria-expanded="false" aria-controls="student_collapse">
                    <i class="fas fa-address-book"></i>
                    <span>Notes</span>
                </a>
                <div id="students_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="uploadfile.php">Notes</a>
                        <a class="collapse-item" href="subject_bank.php">Question Bank</a>
            ...
            <li class="nav-item">
                ...
                <div id="exam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="exam_subject.php">Exam Subject(mcq)</a>
                        <a class="collapse-item" href="exam_subjective_sub.php">Exam Subject(subjective)</a>

...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$username = $_POST["student_name"].rand(0000,9999);
			...
			(student_name, student_address, student_email_id, student_password, student_gender, student_dob, student_image, student_status,student_email_verification_code, student_added_by, student_added_on) 
			VALUES (:student_name, :student_address, :student_email_id, :student_password, :student_gender, :student_dob, :student_image, :student_status,:student_email_verification_code, :student_added_by, :student_added_on)
			";
            $object->execute_query();
			...
			$show = '<div class="alert alert-success">Verification eMail has been send to <b>'.$_POST["student_email_id"].'</b></div>';

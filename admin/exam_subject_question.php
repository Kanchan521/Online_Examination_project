...
?>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                <td><input type="radio" name="bedStatus" id="allot" checked="checked" value="allot"><b>MCQ</b></td>
                                <td><input type="radio" name="bedStatus" id="transfer" value="transfer"><b>Subjective</b></td>
                            </tr>
                        </thead>
                    </table>
                    </div>
...
<div id="examsubjectquestionModal" class="modal fade">
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Exam Names</label>
                        <div class="col-sm-9">
 ...
 <h6 class="col-sm-12"><b>use editor if you want to insert equations or images</b></h6>
                      <div class="col-sm-12">
                           <a href="subjectiveadd.php" class="btn btn-danger">Use Editor</a>
                        </div> 
